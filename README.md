...
The results are `R@100: 36.9; zR@100: 3.7; mR@100: 10.0 `:
...
The results are `R@100: 38.4; zR@100: 4.0; mR@100: 10.3 `:
...
To train the model with 300 triplet queries with backbone, run this command: (8 V100 32G)
The results are `R@100: 36.7; zR@100: 3.8; mR@100: 10.1 `:
